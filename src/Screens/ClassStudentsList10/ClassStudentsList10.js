...
function ClassStudentsList10({ navigation }) {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "rgb(247,245,246)" }}>
      ...
      <Text style={style.studentClassTxt}>Class 10 Students</Text>
      <View>
        {!loader ? (
          <>
            {list.length > 0 ? (
...
export default ClassStudentsList10;
